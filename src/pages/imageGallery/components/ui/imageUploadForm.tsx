...
const ImageUploadForm = ({ onSubmit }: ImageUploadFormProps): React.JSX.Element => {
					...
					<div className="mb-8 flex flex-col gap-2">
						...
						<div className="relative group">
							...
							<div className="absolute h-full w-6 top-0 right-4 flex justify-center items-center">
								<span className="bg-primary group-hover:bg-secondary h-[50%] px-2 py-2 text-text-muted font-md flex justify-center items-center transition-colors duration-100 ease-in-out">
									{120 - caption.length}
								</span>
							</div>
						</div>
